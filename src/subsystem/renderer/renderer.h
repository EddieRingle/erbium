...
typedef ERAPI (*er__renderer_draw_buffer_f)(er_vbuffer *buffer, er_shader_program *program, er_shader_input *program_input);
...
extern er__renderer_draw_buffer_f er__renderer_draw_buffer;
